...
- 🎯 Entry points to execute your program using `python -m <handmovement>` or `$ handmovement` with basic CLI argument parsing.
...
Awesome handmovement created by AmoghNG
